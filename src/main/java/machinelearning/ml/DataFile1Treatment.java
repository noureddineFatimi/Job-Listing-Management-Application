...
public class DataFile1Treatment {

    public static void uniqueValuesof(String champs) throws IOException{
        String filePath = "C:\\Users\\ryane\\Desktop\\TP ENSA S7\\JAVA\\PROJET\\WEB-SCRAPING\\web-scraping\\www.rekrute.com_jobs.json";
    ...
    public static List<AnnonceEmplois> parseData() throws IOException{
        InputStream inputStream = Main.class.getClassLoader().getResourceAsStream("www.rekrute.com_jobs.json");
